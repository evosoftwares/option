...
import '../widgets/my_location_button_widget.dart';
import '../components/bottom_pickup_panel_component.dart';
import '../components/address_search_sheet_component.dart';

class ConfirmPickupPage extends ConsumerStatefulWidget {
  const ConfirmPickupPage({super.key});

  @override
  ConsumerState<ConfirmPickupPage> createState() => _ConfirmPickupPageState();
}

class _ConfirmPickupPageState extends ConsumerState<ConfirmPickupPage>
  ...
  void _onSearchPressed() {
    showModalBottomSheet(
      ...
      builder: (context) => AddressSearchSheetComponent(
      ...
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: BottomPickupPanelComponent(

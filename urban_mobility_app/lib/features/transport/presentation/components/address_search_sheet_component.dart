...
class AddressSearchSheetComponent extends ConsumerStatefulWidget {

  const AddressSearchSheetComponent({
    super.key,
  ...
  @override
  ConsumerState<AddressSearchSheetComponent> createState() => _AddressSearchSheetComponentState();
}

class _AddressSearchSheetComponentState extends ConsumerState<AddressSearchSheetComponent> {

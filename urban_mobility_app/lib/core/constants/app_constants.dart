...
class AppStrings {
  ...
  static const String locationServicesDisabled = 'Serviços de localização estão desabilitados.';
  static const String locationPermissionDenied = 'Permissões de localização foram negadas.';
  static const String locationPermissionDeniedForever = 'Permissões de localização foram negadas permanentemente.';
